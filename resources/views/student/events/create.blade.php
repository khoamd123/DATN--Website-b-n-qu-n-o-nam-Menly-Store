...
@section('title', 'Tạo sự kiện mới - UniClubs')
...
<div class="row">
    <div class="col-12">
        <div class="content-card">
            ...
            <div class="mb-4">
                <h2 class="mb-2">
                    <i class="fas fa-calendar-plus text-teal me-2"></i>Tạo sự kiện mới
                </h2>
                <p class="text-muted mb-0">Tạo sự kiện cho CLB: <strong>{{ $userClub->name }}</strong></p>
            </div>
            ...
            <form method="POST" action="{{ route('student.events.store') }}" enctype="multipart/form-data" id="eventCreateForm">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="6" placeholder="Mô tả chi tiết về sự kiện..." id="description">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('max_participants') is-invalid @enderror" name="max_participants" value="{{ old('max_participants') }}" placeholder="Số người tham gia tối đa" min="1">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('main_organizer') is-invalid @enderror" name="main_organizer" value="{{ old('main_organizer', $user->name ?? '') }}" placeholder="Nhập tên người phụ trách chính">
