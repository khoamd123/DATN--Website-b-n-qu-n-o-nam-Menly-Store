...
class AdminController extends Controller
{
    ...
    public function notifications(Request $request)
    {
        ...
        try {
            ...
            // Lấy thông báo có target là admin hiện tại
            $notifications = \App\Models\Notification::whereHas('targets', function($query) use ($currentUserId) {
            ...
            foreach ($notifications as $notification) {
                $notification->is_read = $notification->reads->where('user_id', $currentUserId)->where('is_read', true)->isNotEmpty();
            }
        } catch (Exception $e) {
