...
class StudentController extends Controller
{
    ...
    public function notifications()
    {
        ...
        foreach ($notifications as $notification) {
            $notification->is_read = $notification->reads->where('user_id', $user->id)->where('is_read', true)->isNotEmpty();
        }

        return view('student.notifications.index', compact('user', 'notifications'));
    }
