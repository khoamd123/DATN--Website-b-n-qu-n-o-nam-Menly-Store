...
class UpdatePostRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            // Delete images messages
            'delete_images.array' => 'Danh sách ảnh xóa không hợp lệ.',
            'delete_images.*.integer' => 'ID ảnh không hợp lệ.',
            'delete_images.*.exists' => 'Ảnh không tồn tại.',
        ];
    }
