...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'UniClubs - Sinh viên'); ?></title>
                ...
                <div class="col-md-6 text-end">
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div>
                            ...
                            <small class="opacity-75"><?php echo e($user->student_id ?? 'Sinh viên'); ?></small>
                        </div>
                        <div class="ms-3">
    ...
    <nav class="main-nav">
        <div class="container">
            <ul class="nav justify-content-center">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('student.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('student.dashboard')); ?>">
                        <i class="fas fa-home me-2"></i> Trang chủ
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('student.clubs*') ? 'active' : ''); ?>" href="<?php echo e(route('student.clubs.index')); ?>">
                        <i class="fas fa-users me-2"></i> Câu lạc bộ
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('student.events*') ? 'active' : ''); ?>" href="<?php echo e(route('student.events.index')); ?>">
                        <i class="fas fa-calendar-alt me-2"></i> Sự kiện
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('student.profile*') ? 'active' : ''); ?>" href="<?php echo e(route('student.profile.index')); ?>">
                        <i class="fas fa-user-circle me-2"></i> Hồ sơ
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('student.notifications*') ? 'active' : ''); ?>" href="<?php echo e(route('student.notifications.index')); ?>">
                        <i class="fas fa-bell me-2"></i> Thông báo
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('student.contact*') ? 'active' : ''); ?>" href="<?php echo e(route('student.contact.index')); ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('student.club-management*') ? 'active' : ''); ?>" href="<?php echo e(route('student.club-management.index')); ?>">
...
<?php /**PATH C:\xampp\htdocs\DATN_Uniclubs\resources\views/layouts/student.blade.php ENDPATH**/ ?>