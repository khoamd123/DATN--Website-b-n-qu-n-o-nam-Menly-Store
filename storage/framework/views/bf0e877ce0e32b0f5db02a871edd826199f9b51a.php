...
<body>
    ...
    <nav class="sidebar">
     ...
     <li class="nav-item">
         <a class="nav-link <?php echo e(request()->routeIs('admin.permissions.demo') ? 'active' : ''); ?>" href="<?php echo e(route('admin.permissions.demo')); ?>">
             <i class="fas fa-magic"></i>
             Demo Tự Động Vai Trò
         </a>
     </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('club.test*') ? 'active' : ''); ?>" href="<?php echo e(route('club.test')); ?>">
...
<?php /**PATH E:\xampp\htdocs\DATN_Uniclubs\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>