        ...
        <div class="user-list">
            ...
            <?php if($newUsers->count() > 0): ?>
                <?php $__currentLoopData = $newUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="user-item">
                        <img src="<?php echo e($user->avatar ?? '/images/avatar/avatar.png'); ?>" 
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\DATN_Uniclubs\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>