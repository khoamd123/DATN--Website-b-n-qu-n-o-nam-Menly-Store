<?php $__env->startSection('title', 'Thêm Bài viết - CLB Admin'); ?>
...
<div class="content-header d-flex justify-content-between align-items-center">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.posts')); ?>">Bài viết</a></li>
...
<div class="row">
    <div class="col-md-8">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="POST" action="<?php echo e(route('admin.posts.store')); ?>" enctype="multipart/form-data" id="postForm" novalidate>
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="post" <?php echo e(old('type') == 'post' ? 'selected' : ''); ?>>Bài viết</option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex justify-content-between">
                <a href="<?php echo e(route('admin.posts')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\DATN_Uniclubs\resources\views/admin/posts/create.blade.php ENDPATH**/ ?>