...
<?php $__env->startSection('title', 'Quản lý CLB - UniClubs'); ?>
...
<div class="row">
    ...
    <div class="col-lg-8">
        ...
        <div class="content-card">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="user-role-badge">
                    ...
                    <?php elseif($userRole === 'vice_president'): ?>
        ...
        <!-- Management Cards -->
        <div class="row">
            <?php if($user->hasPermission('quan_ly_thanh_vien')): ?>
                    ...
                    <div class="management-content">
                        ...
                        <div class="management-stats">
                            <span class="stat-item">
                                <strong><?php echo e($user->clubs->first()->members->count() ?? 0); ?></strong>
            ...
            <?php if($user->hasPermission('tao_su_kien')): ?>
            <div class="col-md-6 mb-4">
                <div class="management-card">
                    <div class="management-icon">
            ...
            <?php if($user->hasPermission('dang_thong_bao')): ?>
            <div class="col-md-6 mb-4">
                <div class="management-card">
                    <div class="management-icon">
            ...
            <?php if($user->hasPermission('xem_bao_cao')): ?>
            <div class="col-md-6 mb-4">
                <div class="management-card">
                    <div class="management-icon">
            ...
            <?php if($user->hasPermission('quan_ly_clb') && $user->getPositionInClub($user->clubs->first()->id ?? null) === 'leader'): ?>
            <div class="col-md-6 mb-4">
    ...
    <div class="col-lg-4">
        <div class="sidebar">
            ...
            <div class="permissions-list">
                ...
                <?php endif; ?>
                <?php if($user->hasPermission('quan_ly_clb')): ?>
                <div class="permission-item">
        ...
        <div class="sidebar mt-4">
            ...
            <div class="club-stats">
                <div class="stat-item">
                    ...
                    <div>
                        <div class="stat-number"><?php echo e($user->clubs->first()->members->count() ?? 0); ?></div>
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DATN_Uniclubs\resources\views/student/club-management/index.blade.php ENDPATH**/ ?>